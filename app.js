...
const TRANSLATIONS = {
  de: {
    ...
    'hero.subtitle.1': 'Falafel Sandwich + Softgetränk 0,33 l – nur 7,00 €',
    'hero.badge.3': '🍕 Mittwoch – Pizza-Tag!',
    'hero.title.3': 'Pizza-Tag!',
    'hero.subtitle.3': 'Jede Pizza 32 cm – nur 8,50 €',
    'hero.badge.4': '🥙 Es ist DÖNERSTAG!',
    'hero.title.4': 'Dönerstag!',
    'hero.subtitle.4': 'Döner Sandwich + Softgetränk 0,5 l – nur 7,00 €',
    ...
    'specials.falafelDesc': 'Falafel Sandwich + Softgetränk 0,33 l',
    'specials.doenerName': 'Dönerstag!',
    'specials.doenerDesc': 'Döner Sandwich + Softgetränk 0,5 l',
    'specials.pizzaName': 'Pizza-Tag',
    'specials.pizzaDesc': 'Jede Pizza 32 cm',
    'specials.pizzaNote': '(außer Funghi, Salami, Margherita – Preis siehe Speisekarte)',
  ...
  en: {
    ...
    'hero.subtitle.1': 'Falafel sandwich + soft drink 0.33 l – only €7.00',
    'hero.badge.3': '🍕 Wednesday – Pizza Day!',
    'hero.title.3': 'Pizza Day!',
    'hero.subtitle.3': 'Any pizza 32 cm – only €8.50',
    'hero.badge.4': '🥙 It\'s DÖNERSTAG!',
    'hero.title.4': 'Dönerstag!',
    'hero.subtitle.4': 'Döner sandwich + soft drink 0.5 l – only €7.00',
    ...
    'specials.falafelDesc': 'Falafel sandwich + soft drink 0.33 l',
    'specials.doenerName': 'Dönerstag!',
    'specials.doenerDesc': 'Döner sandwich + soft drink 0.5 l',
    'specials.pizzaName': 'Pizza Day',
    'specials.pizzaDesc': 'Any pizza 32 cm',
    'specials.pizzaNote': '(excl. Funghi, Salami, Margherita – see menu for prices)',
